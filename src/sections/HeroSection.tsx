...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Portrait */}
      <div className="absolute left-1/2 -translate-x-1/2 z-10 top-1/2 -translate-y-1/2 sm:top-auto sm:translate-y-0 sm:bottom-0 w-[252px] sm:w-[324px] md:w-[396px] lg:w-[468px]">
